...
class EvaluationAgent:
    ...
    def evaluate(self, initial_prompt):
        ...
        for i in range(self.max_interactions):
            ...
            print(f"Prompt:\n{prompt_to_evaluate}")
            response_from_worker = self.worker_agent
                    ...
                    messages=[
                        {
                            ...
                            "content": (
                                ...
                                "Forget previous context. Provide clear, actionable instructions "
...
class RoutingAgent():
    ...
    def route_prompt(self, user_input):
        ...
        for agent in self.agents:
            ...
            agent_emb = self._agent_embedding_cache.get(description)
            if agent_emb is None and description:
                agent_emb = np.array(self.get_embedding(description))
                self._agent_embedding_cache[description] = agent_emb
